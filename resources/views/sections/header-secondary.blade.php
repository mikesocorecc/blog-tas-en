<header class="banner  bg-secondary lg:bg-transparent @isset($class) {{ $class}} @endisset ">
    ...
    <div class="lg:max-w-4xl xl:max-w-6xl mx-auto hidden  lg:flex flex-col lg:flex-row justify-between mt-10">
        ...
        <a href="{{ home_url('/') }}" class=" ">
            <img class="object-contain lg:h-20 xl:h-28" src="@asset('images/logo.svg')">
        </a>
        <!-- Telefono -->
        <div class="flex items-center">
            <a class=" text-primary font-bold lg:text-2xl xl:text-4xl" href="tel:+34937377525"> +34 937 3775 25</a>
        </div>
        {{-- Lenguajes --}}
    ...
    <nav class="lg:max-w-4xl xl:max-w-6xl mx-auto hidden lg:block">
        <!-- Menu movil -->
    ...
    <nav class=" border-gray-200  px-2 sm:px-4 py-2.5   lg:hidden  pt-5">
        <div class="container  flex flex-wrap items-center justify-between mx-auto">
            ...
            <div class=" @if(get_post_type() == 'recursos') fondo-header @else bg-secondary @endif p-4 mt-4 items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                ...
                <ul
                    class="flex flex-col   pl-0 pr-4 pt-4 pb-4 mt-4  rounded-lg   md:flex-row md:space-x-4 md:mt-0 md:text-sm md:font-medium md:border-0   ">
                    @foreach ($menus as $menu)
                        <li>
                            <a href="{{ $menu['url'] }}"
                                class="block py-3 pl-3 pr-4 focus-cero focus-visible:outline-none  md:text-xs text-white  hover:border-b md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0  ">
                                {{ $menu['menu'] }}</a>
                        </li>
                    @endforeach
                    <li>
                        <div x-data="{ expanded: false }">
                            ...
                            <ul x-show="expanded" x-collapse class=" mt-3 pl-6   rounded-lg  bg-secondary ">
