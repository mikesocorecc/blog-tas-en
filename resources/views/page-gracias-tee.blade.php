{{--
  Template Name: pagina gracias tee
--}}
<?php session_start(); ?>
@section('header')
  <div class="     ">
    ...
    <section class="max-w-xs  lg:max-w-4xl mx-auto pb-36">
      <div class="grid lg:grid-cols-2  lg:mt-16">
        <div class="flex flex-col items-center mt-20">
            ...
            <p class="text-verde text-xl  ">{{ __('Tu contenido está listo','sage') }}</p>
        
            <p class="mt-5 text-xl font-semibold text-verde">{{ __('Accede a la guía','sage') }}</p>
            <?php echo do_shortcode('[tagdownload docType="guia-tee" bg="px-20 bg-verde rounded-xl font-bold text-yellow-500 py-3 mt-1" ]');?>
          </div>
          <div class="">
            <img src="@asset('images/recursos/table-con-caja.png')" alt="" class="mx-auto   mt-5 lg:mt-0">
          </div>
        </div>
    </section>
  </div>
...
@section('content')
  <section class="max-w-xs sm:max-w-md md:max-w-xl lg:max-w-4xl xl:max-w-6xl mx-auto bg-verde   rounded-[3rem] p-5 lg:p-10  mb-16"> 
