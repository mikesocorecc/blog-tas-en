...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Este valor es el nombre de su aplicación. Este valor se usa cuando el
    | El marco debe colocar el nombre de la aplicación en una notificación o
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Este valor determina el "entorno" que su aplicación es actualmente
    |Ejecutando. Esto puede determinar cómo prefiere configurar varios
    |Servicios La aplicación utiliza.Establezca esto en su archivo ".env".
    |
    */
